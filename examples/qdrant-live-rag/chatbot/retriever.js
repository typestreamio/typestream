...
//
// The pipeline stores each article's title/body/category in the Qdrant point
// payload, so a single vector search returns everything the chatbot needs.
// ---------------------------------------------------------------------------
...
export async function retrieve(question, k = 3) {
  ...
  // or the vector search is meaningless.
